...
export function Tokenomics() {
  return (
    <div className="center-tokenomics">
      <div className="wrapper-tokenomics">
        <button className="goto-tokenomics">TOKENOMICS</button>
        <div className="card-wrap-tokenomics">
          <div className="card-tokenomics">
            <svg
              ...
              enableBackground="new 0 0 216.3 234.1"
            >
              <g id="shadow">
                <g>
                  <path
			...
			179.8,199.6 179.8,206.6 179.7,221.8 137.1,236.3 97.8,224.2 		"
				...
				c-1.3,0.7-2.9,0.3-3.8-0.8l-3-3.8l63.7-50.6L146.9,172.5z"
                  ...
                  <g>
                    <ellipse
                      transform="matrix(0.7832 -0.6217 0.6217 0.7832 -96.3369 111.7049)"
                      fill="#F9C441"
                      cx="112"
                      cy="194"
                      rx="40.7"
...
export default compose(withConnect)(Tokenomics);
